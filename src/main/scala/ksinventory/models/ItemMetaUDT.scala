...
class ItemMetaUDT(){
  ...
  def this(b: util.List[PatternUDT], bk: BookMetaUDT, dn: String, e: String, es: util.Map[String, Integer], f: FireworkMetaUDT, le: ColorUDT, lo: util.List[String], m: MapMetaUDT, p: PotionMetaUDT, s: String){
    this()
    this.banner = b
    this.book = bk
